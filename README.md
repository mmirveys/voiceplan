...
A mobile-first, installable planner that turns natural speech into dated tasks.
...
Then open `http://localhost:8080`. Chrome or Safari is recommended for voice input.
